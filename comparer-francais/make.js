...
for (livre = 1 ; livre != 28 ; livre++)
{
	...
	for (chapitre = 1 ; chapitre != maxchapitres; chapitre++)
	{
		...
		for (verset = 1 ; verset != maxversets; verset++)
		{
			...
			if (sebastien_net[livre][chapitre][verset] && sebastien_net[livre][chapitre][verset] != "")
				sebastien_net[livre][chapitre][verset] = sebastien_net[livre][chapitre][verset].replace(/#/g,' ');
...
body+=`\
<div id="v`+verset+`"></div>
<a href="#a">Δ </a><span class="b">VERSET `+verset+`</span>&ensp;&ensp;<a href="../comparer-grec/`+lch+`">GRE</a>
